...
describe('ConversationItem Component', () => {
  ...
  it('should render direct conversation correctly', () => {
    render(<ConversationItem conversation={directConversation} isActive={false} onClick={vi.fn()} />);
  ...
  it('should render group conversation correctly', () => {
    render(<ConversationItem conversation={groupConversation} isActive={false} onClick={vi.fn()} />);
  ...
  it('should call onClick when clicked', () => {
    ...
    render(<ConversationItem conversation={directConversation} onClick={mockClick} isActive={false} />);
  ...
  it('should apply active class when isActive is true', () => {
    const { container } = render(<ConversationItem conversation={directConversation} isActive={true} onClick={vi.fn()} />);
